...
@Contract(
        name = "TrustNewsBooker",
        info = @Info(
                title = "TrustNewsBooker contract",
                description = "TrustNewsBooker chaincode",
...
public final class TrustNewsBooker implements ContractInterface {
    ...
    @Transaction()
    public TrustNews addTrustNews(final Context ctx, 
    							  final String id, 
     ...
     */
    @Transaction()
    public TrustNews changeHomeOwnership(final Context ctx, final String id, final String newSignature) {
